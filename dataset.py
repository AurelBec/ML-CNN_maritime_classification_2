...
def read_data_sets(train_dir, fake_data=False, one_hot=False,
    ...
    #all_images = numpy.load(train_dir)
    all_images = numpy.array([numpy.array(Image.open(fname)) for fname in glob.glob(train_dir+'/*/*.jpg')])

    #train_labels_original = numpy.load('./npy/label.npy')
    train_labels_original = numpy.load(train_dir)
