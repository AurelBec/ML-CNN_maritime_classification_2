...
def cnn_model_fn(features, labels, mode):
  ...
  # Input Layer
  # Images are 800x240 pixels, and have 3 color channel
  input_layer = tf.reshape(features["x"], [-1, 800, 240, 3])

  # Convolutional Layer #1
  # Computes 32 features using a 5x5 filter with ReLU activation.
  # Padding is added to preserve width and height.
  # Input Tensor Shape: [batch_size, 800, 240, 3]
  # Output Tensor Shape: [batch_size, 800, 240, 96]
  ...
  # Input Tensor Shape: [batch_size, 800, 240, 96]
  # Output Tensor Shape: [batch_size, 400, 120, 96]
  pool1 = tf.layers.max_pooling2d(inputs=conv1, pool_size=[2, 2], strides=2)

  # Convolutional Layer #2
  # Computes 64 features using a 5x5 filter.
  # Padding is added to preserve width and height.
  # Input Tensor Shape: [batch_size, 400, 120, 96]
  # Output Tensor Shape: [batch_size, 400, 120, 192]
  ...
  # Input Tensor Shape: [batch_size, 400, 120, 192]
  # Output Tensor Shape: [batch_size, 200, 120, 192]
  pool2 = tf.layers.max_pooling2d(inputs=conv2, pool_size=[2, 2], strides=2)

  # Flatten tensor into a batch of vectors
  # Input Tensor Shape: [batch_size, 200, 120, 192]
  # Output Tensor Shape: [batch_size, 200 * 120 * 192]
  pool2_flat = tf.reshape(pool2, [-1, 200 * 120 * 192])
